...
<header>
    ...
    <form action="perg1.php" method="post">
        ...
        <button type="submit" name="submitperg1" id="submitperg1">Next <img src="https://img.icons8.com/ios-glyphs/30/ffffff/chevron-right.png"/></button>
        </div>
    </form>
