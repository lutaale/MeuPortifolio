...
<head>
    ...
    <title>Form</title>
    <link rel="stylesheet" href="formulario11.css">
</head>
<body>
    <section>
        <form action="formulario11.php"method="post">
            <div class="container">
                <div class="box box-1 active">
                    <h2>Select the type of tile</h2>
                    <div class="form-group">
                        <div class="border">
                            <input type="radio" name="box1" id="option1" value="Ceramic or Porcelain">
                            <label for="option1">Ceramic or Porcelain</label>
                        </div>
                    </div>
                   <div class="form-group">
                        <div class="border">
                            <input type="radio" name="box1" id="option2" value="Natural stone (granite, marble, limestone, etc.)">
                            <label for="option2">Natural stone (granite, marble, limestone, etc.)</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="border">
                            <input type="radio" name="box1" id="option3" value="Not sure">
                ...
                <div class="box box-3">
                    ...
                    <div class="form-group">
                        <div class="border">
                            <input type="radio" name="box3" id="no" value="no">
                            <label for="no">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="border">
                            <input type="radio" name="box3" id="yes" value="yes">
        ...
        <div class="form-group">
            <div class="border">
                <input type="radio" name="perg5" id="homeresidence" value="home/Residence" required>
                <label for="perg2">Home/Residence</label>
            </div>
        </div>
        <div class="form-group">
            <div class="border">
                <input type="radio" name="perg5" id="business" value="Business"required>
        ...
        <div class="btns">
          ...
          <div class="form-group">
              <div class="border">
                  <input type="radio" name="perg6" id="yes" value="yes">
                  <label for="yes">Yes</label>
              </div>
           <div class="form-group">
               <div class="border">
                   <input type="radio" name="perg6" id="no" value="no">
                   <label for="no">No</label>
               </div>
           </div>
           <div class="form-group">
               <div class="border">
                   <input type="radio" name="perg6" id="option2" value="no, but authorized to make changes">
    ...
    <script src="formulario11.js"></script>
</body>
</html>