...
<head>
    ...
    <title>Pagina de controle CredfacillBR</title>
    <style>
        *{
            margin: 0px;
            padding: 0px;
    ...
    <section>
        ...
        <nav id="navbar">
             <div class="optionslist">
                 ...
                 <button class="btns" onclick="sair()">Sair</button>
             </div>
        </nav>
        <main>
            <div class="logo">
            ...
            <div class="pedidos">
                ...
                <?php
                 while($user_data = mysqli_fetch_assoc($resulti)){
                     ...
                     echo "<div class='dados'>".'R$'.$user_data ['valordesejado']."</div>";
                     echo "<div class='dados'>".$user_data['parcelas'].'X'."</div>";    
                     echo "</div>";
